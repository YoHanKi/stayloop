...
class ReservationV1Controller(
    ...
    override fun reserve(
        ...
        reservationFacade.reserve(request.toCommand(loginUser.loginId, idempotencyKey))
    ...
    override fun cancel(
        ...
        reservationFacade.cancel(loginUser.loginId, reservationId)
            .let { ReservationV1Dto.ReservationResponse.from(it) }
            .let { ApiResponse.success(it) }
    ...
    override fun getReservation(
        ...
        reservationFacade.getReservation(loginUser.loginId, reservationId)
            .let { ReservationV1Dto.ReservationResponse.from(it) }
            .let { ApiResponse.success(it) }
    ...
    override fun getMyReservations(
        ...
        reservationFacade.getMyReservations(loginUser.loginId, page, size)
            .map { ReservationV1Dto.ReservationResponse.from(it) }
            .let { ApiResponse.success(it) }
}
