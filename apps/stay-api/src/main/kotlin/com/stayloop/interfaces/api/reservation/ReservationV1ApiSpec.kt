...
interface ReservationV1ApiSpec {
    @Operation(summary = "예약 생성", description = "기간·인원·객실로 예약을 만들고 날짜별 재고를 차감합니다.")
    fun reserve(loginUser: LoginUser, request: ReservationV1Dto.ReserveRequest): ApiResponse<ReservationV1Dto.ReservationResponse>
